...
public class SpringbootRestAssuredAutomationFrameworkTests {
	...
	//Test multiple sets of different data without iterating the Test method in for loop
	@DataProvider(name = "empDataProvider")
	public Object [][] getEmployeeData(){
		Object[][] employeeData =
				{{"Lake","Wills", new Float(8964.35)}, {"Tim","Sands", new Float(10986.49)},
						{"Duke","Royce", new Float(8650.98)}};
		return employeeData;
	}

	//Insert Multiple Employees into Database using @DataProvider
	@Test(dataProvider = "empDataProvider")
	public void saveEmployeeUsingDataProvider(String empFirstName, String empLastName, Float salary){
		RestAssured.baseURI = "http://localhost:8080/rest/employee/saveEmployee";
		RequestSpecification httpRequest = RestAssured.given();
		JSONObject jsonObjectReqParams = new JSONObject();
